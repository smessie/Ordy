...
interface ApiService {
    ...
    @POST("auth/register")
    fun register(@Body body: UserRegister): Observable<Void>
    ...
    fun createInviteGroup(@Path("groupId") groupId: Int, @Path("userId") userId: Int): Observable<Void>

    @DELETE("groups/{groupId}/invites/{userId}")
    fun deleteInviteGroup(@Path("groupId") groupId: Int, @Path("userId") userId: Int): Observable<Void>

    @DELETE("groups/{groupId}/members/{userId}")
    fun deleteMemberGroup(@Path("groupId") groupId: Int, @Path("userId") userId: Int): Observable<Void>
    ...
    fun userActionInvites(@Body inviteAction: InviteAction, @Path("groupId") groupId: Int): Observable<Void>

    @POST("user/invites/{groupId}/leave")
    fun userLeaveGroup(): Observable<Void>
    ...
    fun userUpdateOrders(@Path("orderId") orderId: Int, @Body body: OrderUpdate): Observable<Void>
    ...
    fun userUpdateOrderItem(@Path("orderId") orderId: Int, @Path("orderItemId") orderItemId: Int, @Body body: OrderUpdateItem): Observable<Void>

    @DELETE("/user/orders/{orderId}/items/{orderItemId}")
    fun userDeleteOrderItem(@Path("orderId") orderId: Int, @Path("orderItemId") orderItemId: Int): Observable<Void>
    ...
    fun userSetPaid(@Path("orderId") orderId: Int, @Path("userId") userId: Int, @Body body: PaymentUpdate): Observable<Void>

    @POST("/user/payments/{orderId}/{userId}/notification")
    fun userNotifyDeptor(@Path("orderId") orderId: Int, @Path("userId") userId: Int): Observable<Void>
