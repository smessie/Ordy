...
def update_json():
  ...
  os.system('''curl --globoff -o osm_output.json "http://overpass-api.de/api/interpreter?data=[out:json];node['amenity'='fast_food'](50.975798,3.582471,51.144645,3.813184);out;"''')
...
def get_content():
  ...
  for id, name, latitude, longitude, address, private, cuisine in cursor:
    print("id: {}, Location: {}, latitude: {}, longitude: {}, address: {}, private: {}, cuisine: {}".format(id, name, latitude, longitude, address, private, cuisine))
...
def test_cuisine():
  ...
  cuisine_names = ['kebab', 'fries', 'pizza', 'sandwiches', 'chinese', 'thai', 'greek', 'donuts', 'burgers', 'sushi', 'wok', 'unknown']
